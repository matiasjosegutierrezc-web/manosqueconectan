...
export default function MisionVision() {
  return (
    <section id="quienes-somos" className="bg-off-white min-h-screen" style={{ scrollMarginTop: '60px' }}>
      <div className="grid grid-cols-1 md:grid-cols-2 items-stretch">

        {/* Misión */}
        <Reveal className="bg-cream py-24 px-12">
        ...
        {/* Visión */}
        <Reveal delay={200} className="bg-[#3D5A6B] py-24 px-12">
