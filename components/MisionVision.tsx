...
export default function MisionVision() {
  return (
    <section id="quienes-somos" className="bg-off-white min-h-[calc(100vh-88px)]" style={{ scrollMarginTop: '60px' }}>
      <div className="grid grid-cols-1 md:grid-cols-2 items-stretch">

        {/* Misión */}
        <Reveal className="bg-cream py-32 px-12">
        ...
        {/* Visión */}
        <Reveal delay={200} className="bg-[#3D5A6B] py-32 px-12">
